...
namespace VivoBuilder
{
    public partial class Connect : Form
    {
        ...
        {
            InitializeComponent();
            txtSqlServerDBName.Text = ConfigurationManager.AppSettings["serverName"];
            txtSqlServerInitialCat.Text = ConfigurationManager.AppSettings["databaseName"];
            txtSqlServerUserID.Text = ConfigurationManager.AppSettings["userID"];
            txtSqlServerPassword.Text = ConfigurationManager.AppSettings["password"];
        }
        ...
        private void btnSqlServerOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                configuration.AppSettings.Settings["serverName"].Value = txtSqlServerDBName.Text;
                configuration.AppSettings.Settings["databaseName"].Value = txtSqlServerInitialCat.Text;
                configuration.AppSettings.Settings["userID"].Value = txtSqlServerUserID.Text;
                configuration.AppSettings.Settings["password"].Value = txtSqlServerPassword.Text;
                configuration.Save();
